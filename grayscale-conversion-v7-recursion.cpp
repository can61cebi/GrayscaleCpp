...
void dosyaEkleRecursive(int dosyaNumarasi, int dosyaSayisi) {
    if (dosyaNumarasi > dosyaSayisi) {
        return;
    }
    ...
    dosyaEkleRecursive(dosyaNumarasi + 1, dosyaSayisi);
}
...
int main() {
    ...
    dosyaEkleRecursive(1, dosyaSayisi);
